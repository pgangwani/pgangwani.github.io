...
const SocialIcons = (props, context) => {
  ...
  return (
    <div className="social-icons animate-icons">
        <a target="_blank" rel="noopener noreferrer" href="https://github.com/pgangwani" style={ { color: colorPrimary } }><i className="fab fa-github"></i></a>
        <a target="_blank" rel="noopener noreferrer" href="https://twitter.com/pawan_gangs" style={ { color: colorPrimary } }><i className="fab fa-twitter"></i></a>
        <a target="_blank" rel="noopener noreferrer" href="https://stackoverflow.com/users/6261217/pawan-gangwani" style={ { color: colorPrimary } }><i className="fab fa-stack-overflow"></i></a>
        <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/pawan-gangwani-17759638/" style={ { color: colorPrimary } }><i className="fab fa-linkedin"></i></a>
        <a target="_blank" rel="noopener noreferrer" href="https://medium.com/@pawangangwani0" style={ { color: colorPrimary } }><i className="fab fa-medium"></i></a>
        <a className="devto" target="_blank" rel="noopener noreferrer" href="https://dev.to/pgangwani">
        ...
        <a target="_top" rel="noopener noreferrer" href="mailto:pawangangwani0@gmail.com" style={ { color: colorPrimary } }>
          <i  className="fab fa fa-envelope-square"></i>
        </a>
      </div>
  );
};
